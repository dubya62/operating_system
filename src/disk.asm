...
; basic disk access for ATA disks
;
; This basic access will allow an interface
; to read/write from/to sections of the disk
; Advanced disk operations can be implemented
